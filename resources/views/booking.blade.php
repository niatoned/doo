                ...
                <form method="POST" action="{{ route('bookings.store') }}">
                    ...
                    <div class="preferences">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-4 sm-box">
                                    <div class="styled-radio">
                                        <input type="radio" id="option-one" data-name="Standard Cleaning" name="selector">
                                        <label for="option-one">STANDARD</label>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-4 sm-box">
                                    <div class="styled-radio">
                                        <input type="radio" id="option-two" data-name="Deep Cleaning" name="selector">
                                        <label for="option-two">DEEP</label>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-4 sm-box">
                                    <div class="styled-radio">
                                        <input type="radio" id="option-three" data-name="Move In/Out" name="selector">
                            ...
                            <div class="row">
                                <div class="col-md-3 sm-box">
                                    <div class="styled-radio styled-radio2">
                                        <input type="radio" data-name="One Time" id="one-time" name="selector1">
                                        <label for="one-time">ONE TIME</label>
                                    </div>
                                </div>
                                <div class="col-md-3 sm-box">
                                    <div class="styled-radio styled-radio2">
                                        <input type="radio" data-name="Weekly" id="weekly" name="selector1">
                                ...
                                <div class="col-md-3 sm-box">
                                    <div class="styled-radio styled-radio2">
                                        <input type="radio" data-name="Bi-weekly" id="bi-weekly" name="selector1">
                                        <label for="bi-weekly">BI-WEEKLY</label>
                                    </div>
                                </div>
                                <div class="col-md-3 sm-box">
                                    <div class="styled-radio styled-radio2">
                                        <input type="radio" data-name="Monthly" id="monthly" name="selector1">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="preference-icon">
                                    <img src="{{asset ('app-assets/images/double-bed.svg')}}">
                                    <p>BEDROOMS</p>
                                </div>
                                <div class="preference-quantity">
                                    <div class="counter js-counter">
                                        ...
                                        <div class="counter__item counter__item--center">
                                            <input class="counter__value js-counter-value" type="text" id="bedroom" name="bedroom" value="1" disabled="disabled" tabindex="-1" min="0" max="10" required />
                                            <input type="hidden" name="hbedroom" id="hbedroom">
                                        </div>
                                        <div class="counter__item">
                            ...
                            <div class="col-md-5">
                                <div class="preference-icon">
                                    <img src="{{asset ('app-assets/images/shower.svg')}}">
                                    <p>BATHROOMS</p>
                                </div>
                                <div class="preference-quantity">
                                    <div class="counter js-counter">
                                        ...
                                        <div class="counter__item counter__item--center">
                                            <input class="counter__value js-counter-value" type="text" id="bathroom" name="bathroom" value="1" disabled="disabled" tabindex="-1"  min="0" max="10" required/>
                                            <input type="hidden" name="hbathroom" id="hbathroom">
                                        </div>
                                        <div class="counter__item">
                                            <a class="counter__plus js-counter-btn fa fa-plus" aria-hidden="true" data-action="plus"></a>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <ul class="topics d-flex flex-wrap">
                                        <li><input type="checkbox" name="box-1" id="box-1" />
                                        ...
                                        <li><input type="checkbox" name="box-2" id="box-2" />
                                        ...
                                        <li><input type="checkbox" id="box-3" name="box-3" checked />
                                        ...
                                        <li><input type="checkbox" name="box-4" id="box-4" />
                        ...
                        <div class="preference-radio mt-4">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <textarea name="comment" class="optinal-textarea"></textarea>
                                </div>
                            </div>
                        </div>
                        <!--// Comment box -->
                                ...
                                <div class="preference-radio mt-4">
                                    ...
                                    <div class="preference-quantity houres">
                                        <div class="counter js-counter">
                                            ...
                                            <div class="counter__item counter__item--center">
                                                <input class="counter__value js-counter-value" type="text" id="hours" name="hours" value="1" disabled="disabled" tabindex="-1" />
                                                <input type="hidden" name="hhours" id="hhours">
                                            </div>
                                            <div class="counter__item">
                                                <a class="counter__plus js-counter-btn fa fa-plus" aria-hidden="true" data-action="plus"></a>
                                            </div>
                                        </div>
                                        <p>How many hours would you be available?</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="preference-radio mt-4">
                            ...
                            <div class="row">
                                <div class="col-md-3 sm-box">
                                    <div class="styled-radio styled-radio2">
                                        <input type="radio" id="timer1" data-name="8:00 AM" name="selector2">
                                        <label for="timer1">8:00 AM</label>
                                    </div>
                                </div>
                                <div class="col-md-3 sm-box">
                                    <div class="styled-radio styled-radio2">
                                        <input type="radio" id="timer2" data-name="9:00 AM" name="selector2">
                                        <label for="timer2">9:00 AM</label>
                                    </div>
                                </div>
                                <div class="col-md-3 sm-box">
                                    <div class="styled-radio styled-radio2">
                                        <input type="radio" id="timer3" data-name="10:00 AM" name="selector2">
                                        <label for="timer3">10:00 AM</label>
                                    </div>
                                </div>
                                <div class="col-md-3 sm-box">
                                    <div class="styled-radio styled-radio2">
                                        <input type="radio" id="timer4" data-name="1:00 PM" name="selector2">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-3 sm-box">
                                    <div class="styled-radio styled-radio2">
                                        <input type="radio" id="timer5" data-name="2:00 PM" name="selector2">
                                        <label for="timer5">2:00 PM</label>
                                    </div>
                                </div>
                                <div class="col-md-3 sm-box">
                                    <div class="styled-radio styled-radio2">
                                        <input type="radio" id="timer6" data-name="3:00 PM" name="selector2">
                                        <label for="timer6">3:00 PM</label>
                                    </div>
                                </div>
                                <div class="col-md-3 sm-box">
                                    <div class="styled-radio styled-radio2">
                                        <input type="radio" id="timer7" data-name="4:00 PM" name="selector2">
                                        <label for="timer7">4:00 PM</label>
                                    </div>
                                </div>
                                <div class="col-md-3 sm-box">
                                    <div class="styled-radio styled-radio2 radio-disable">
                                        <input type="radio" id="timer8" data-name="5:00 PM" name="selector2" disabled>
                                        <label for="timer8" disabled>5:00 PM</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card-details">
                                        <input type="text" name="card_number" maxlength="19" placeholder="Card number" class="card-number card-num cc-number-input">
                                        <img src="{{asset ('app-assets/images/credit-card-removebg.png')}}" class="visa-img" alt="visa-icon">
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-3">
                                    <div class="card-details">
                                        <input type="text" maxlength="5" placeholder="MM/YY" class="card-number cc-expiry-input">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="card-details">
                                        <input type="number" maxlength="3" placeholder="CVV" class="card-number cvc-input">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="card-details">
                                        <input type="text" placeholder="Name as on Card" name="name" class="card-number">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="preference-radio mt-5">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="card-details">
                                        <input type="number" placeholder="Phone Number" name="phone_number" class="card-number">
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-9">
                                    <div class="card-details">
                                        <input type="text" name="address" id="address" placeholder="Your Full Address" class="card-number">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="card-details">
                                        <input type="number" placeholder="zipcode" id="zip" class="card-number">
                                    </div>
                                </div>
                            </div>
                            <input type="hidden" name="type" id="htype">
                            <input type="hidden" name="frequency" id="hfrequency">
                            <input type="hidden" name="hour" id="hhour">
                            <div class="row mt-3">
                                <div class="col-md-12">
                    ...
                    <div class="fesilities">
                        <ul>
                            <li><i class="fa fa-paint-brush" aria-hidden="true"></i>
                                ...
                                <p id="ttype">Standard Cleaning</p>
                            </li>
                            <li><i class="fa fa-calendar" aria-hidden="true"></i>
                                <p id="tdate">Tues. 12/31/2016 </p><p id="thour">@ 9:00 AM</p>
                            </li>
                            <li><i class="fa fa-clock-o" aria-hidden="true"></i>
                                <p id="thours">4 hours</p>
                            </li>
                            <li><i class="fa fa-refresh" aria-hidden="true"></i>
                                <p id="tfrequency">One time</p>
                            </li>
                            <li><i class="fa fa-map-marker" aria-hidden="true"></i>
                                <p id="taddress">1650 Broadway Apt. 23B New York, NY 10023</p>
                            </li>
                        </ul>
