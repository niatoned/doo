...
document.addEventListener('click', function chnageCount(evt) {
    ...
    if(counterInput.id == "hours"){
        $('#thours').text(counterInput.value + ' Hours');
        document.getElementById("hhours").value = counterInput.value;
    }
    if(counterInput.id == "bedroom"){
        document.getElementById("hbedroom").value = counterInput.value;
    }
    if(counterInput.id == "bathroom"){
        document.getElementById("hbathroom").value = counterInput.value;
